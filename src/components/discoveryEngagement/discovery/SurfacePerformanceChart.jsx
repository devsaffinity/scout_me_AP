...
const SurfacePerformanceChart = ({ data = [], subtitle = '' }) => {
  return (
    <section className={cardClass}>
      ...
      <div className="h-[290px] w-full 2xl:h-[340px]">
        <BarChart
          data={data}
          responsive
        ...
        >
          ...
          <YAxis tickLine={false} axisLine={false} width={68} tickMargin={10} />
          <Tooltip
            contentStyle={{
              borderRadius: 16,
...
export default SurfacePerformanceChart;
